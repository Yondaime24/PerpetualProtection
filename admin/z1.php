       ...
       <li class="nav-item dropdown no-arrow mx-1">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="alertsDropdown">
             <div class="scroll">
            <?php 
               $query = "SELECT * from `clients_request` order by `date` DESC";
               if(count(fetchAll($query))>0){
      ...
      <?php
        ...
        <li class="nav-item dropdown no-arrow mx-1">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="messagesDropdown">
            <div class="scroll">
            <?php 
               $query = "SELECT * from `clients` WHERE status='active' order by `date_registered` DESC";
               if(count(fetchAll($query))>0){
                  foreach(fetchAll($query) as $i){
            ?>
            <?php                                      
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="changeUsername&Pass.php">Change Username & Password</a>
            <div class="dropdown-divider"></div>
           ...
           <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-money-bill-wave"></i>
               Payments
               <span style="margin-left: 610px;">Legend:
                 ...
                 <span class="badge" style="font-size: 15px; background: red"><small class="text-white">No Payment Data</small></span>
               </span>
            </div>
            <div class="card-body">
