<?php 
  ...
  if (isset($_POST['sendMessage_btn'])) {
    ...
    $query = "INSERT INTO admin_message (`client_id`, `requestReason`, `datetime`, `message`, `type`, `status`)VALUES('$client_id', 'N/A', CURRENT_TIMESTAMP, '$message', 'Message', 'unread')";
        ...
        echo "<script>window.open('adminClientBeneficiaries.php?client_id=$client_id','_self')</script>";
...
<!--          <li class="nav-item">
    ...
    <div id="content-wrapper">
      ...
      <?php
            ...
            while($row=mysqli_fetch_array($query)){
        ?>
          <form action="adminClientBeneficiaries.php?client_id=<?php echo $row['client_id'] ?>" method="post" enctype="multipart/form-data">
        <?php }?>
      ...
      <?php
        $query=mysqli_query($db,"SELECT * FROM beneficiary WHERE client_id='$client_id' LIMIT 1")or die(mysqli_error());
        while($row=mysqli_fetch_array($query)){
      ?>
             <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                       <input type="text" id="age" class="form-control" value="<?php echo $row['name'];?>" readonly>
                    <label id="label3"><b>Name:</b></label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-label-group">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                       <input type="text" id="age" class="form-control" value="<?php echo $row['relationship'];?>" readonly>
                    <label id="label3"><b>Relation:</b></label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-label-group">
                      <input type="text" id="age" class="form-control" value="<?php echo $row['contact_num'];?>" readonly>
                    <label id="label4"><b>Contact Number:</b></label>
                  </div>
                </div>
              </div>
            </div>
      ...
      <?php
        $query=mysqli_query($db,"SELECT * FROM beneficiary WHERE client_id='$client_id' LIMIT 1, 1")or die(mysqli_error());
        while($row=mysqli_fetch_array($query)){
      ?>
             <div class="form-group">
              <div class="form-row">
      ...
      <?php
        $query=mysqli_query($db,"SELECT * FROM beneficiary WHERE client_id='$client_id' LIMIT 2, 1")or die(mysqli_error());
        while($row=mysqli_fetch_array($query)){
      ?>
             <div class="form-group">
              <div class="form-row">
        ...
        <?php }?>
          ...
          <div class="card-footer text-center"> 
           ...
           <form action="adminClientBeneficiaries.php">
          <?php
                $query=mysqli_query($db,"SELECT * FROM clients WHERE client_id='$client_id'")or die(mysqli_error());
                while($row=mysqli_fetch_array($query)){
            ?>
          ...
          ?>
            ...
            <a class="btn btn-outline-primary" href="adminViewClients.php?client_id=<?php echo $client_id ?>">Profile</a>
            <a class="btn btn-outline-secondary" href="adminClientReferences.php?client_id=<?php echo $client_id ?>">References</a>
            <a class="btn btn-outline-danger" onClick="return confirm('Are you sure you want to deactivate this account?' )" href="deactivatedClient.php?client_id=<?php echo $client_id ?>">Deactivate</a>
         <?php }
          ?>
           <?php }?>
           </form>
