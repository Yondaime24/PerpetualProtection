         ...
         <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-check"></i> Granted Request</div>
            <div class="card-body">
              <div class="table-responsive">

                <?php
                                     
                  $query = "SELECT * FROM `clients_request` WHERE request_status='granted' ORDER BY `date`";
                    ...
                    echo "<tr>";
                      ...
                      echo "<td> 
                       <p>
                        ...
                        <a class=\"btn btn-outline-primary btn-sm btn-block\" href=\"clientRequest.php?request_id=$res[request_id]\">View Request</a>
