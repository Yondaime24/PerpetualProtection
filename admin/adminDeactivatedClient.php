...
<html lang="en">
  ...
  <head>
    ...
    <title>Perpetual Protection | Admin Deactivated Clients</title>
         ...
         <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-header">
             ...
             Deactivated Clients</div>
            <div class="card-body">
              <div class="table-responsive">

                <?php
                                     
                  $query = "SELECT * FROM clients WHERE status='deactivated' && user_type='client'";
                    ...
                    <?php
                      if($result){
                        ...
                        <div class=\"collapse\" id=\"collapseExample\">
                                      ...
                                      <a class=\"btn btn-outline-info btn-sm btn-block\" href=\"adminClientReferences.php?client_id=$res[client_id]\">References</a>
                                      <a class=\"btn btn-outline-danger btn-sm btn-block\" href=\"adminClientActivation.php?client_id=$res[client_id]\">Activate</a>
                                       <a class=\"btn btn-outline-warning btn-sm btn-block\" href=\"adminViewPayments.php?client_id=$res[client_id]\">View Payments</a>
                        </div>
                                  </td>";
                            ?>
                            </ul>
