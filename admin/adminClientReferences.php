...
<?php 
  ...
  if (isset($_POST['sendMessage_btn'])) {
    ...
    $query = "INSERT INTO admin_message (`client_id`, `requestReason`, `datetime`, `message`, `type`, `status`)VALUES('$client_id', 'N/A', CURRENT_TIMESTAMP, '$message', 'Message', 'unread')";
        ...
        echo "<script>window.open('adminClientReferences.php?client_id=$client_id','_self')</script>";
...
<html lang="en">
  ...
  <head>
    ...
    <title>Perpetual Protection | Admin Client References</title>
...
<!--          <li class="nav-item">
    ...
    <div id="content-wrapper">
      ...
      ?>
             <div class="form-group">
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                      <input type="text" id="age" class="form-control" value="<?php echo $row['address'];?>" readonly>
                    <label id="label4"><b>Address:</b></label>
                  </div>
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                      <input type="text" id="age" class="form-control" value="<?php echo $row['relation'];?>" readonly>
                    <label id="label4"><b>Relation:</b></label>
                  </div>
                </div>
              </div>
            </div>
      ...
      ?>
        ...
        <?php }?>
         ...
         <form action="adminClientReferences.php">
          <?php
                $query=mysqli_query($db,"SELECT * FROM clients WHERE client_id='$client_id'")or die(mysqli_error());
                while($row=mysqli_fetch_array($query)){
            ?>
    ...
    <div class="container">
      ...
      ?>
        ...
        <form action="adminClientReferences.php?client_id=<?php echo $row['client_id'] ?>" method="post" enctype="multipart/form-data">
