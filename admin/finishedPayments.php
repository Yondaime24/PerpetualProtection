         ...
         <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-handshake"></i> Finished 
              Payments</div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php
                  ...
                  $query = "SELECT * FROM clients WHERE payment_status='finished' && user_type='client'";
              ...
              <?php     
                            ...
                            ?>
                               <td style="background: red; color: white;"><?php echo date('F j, Y / g:i a',strtotime($row['date']))?></td>  
                            <?php }?>
                            <?php
                            }else{
                            ?>
                              <td style="background: #2ecc71; color: white;"><?php echo $res['fname'];?> <?php echo $res['mname'];?> <?php echo $res['lname'];?></td> 
                              <td style="background: #2ecc71; color: white;"><?php echo $res['plan_type'];?></td> 
                              <td style="background: #2ecc71; color: white;"><?php echo $res['payment_mode'];?></td>  
                              <td style="background: #2ecc71; color: white;"><?php echo date('F j, Y / g:i a',strtotime($res['date_registered']))?></td> 
                            <?php
                                $query=mysqli_query($db,"SELECT * from `payment` WHERE `client_id`='".$res['client_id']."' order by `payment_id` DESC LIMIT 1")or die(mysqli_error());
                                  while($row=mysqli_fetch_array($query)){
                            ?>
                               <td style="background: #2ecc71; color: white;"><?php echo date('F j, Y / g:i a',strtotime($row['date']))?></td>  
                            <?php }?>
                            </ul>
                            <?php }
                             echo "<td class=\"text-center\">
                                  ...
                                  <div class=\"collapse\" id=\"collapseExample\">
                                      ...
                                      <a class=\"btn btn-outline-warning btn-sm btn-block\" href=\"adminViewPayments.php?client_id=$res[client_id]\">Payments</a>
