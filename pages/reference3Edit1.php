...
<head>
      ...
      <title>Perpetual Protection | Edit Reference 3</title>
...
<form class="" id="reg_form" action="reference3Edit1.php" method="post" onsubmit="return checkInputs()" enctype="multipart/form-data">
    ...
    <?php echo display_error(); ?>
        ...
        <div class="user-details">
          ...
          <div class="input-box" hidden="">
            ...
            <?php
                $query=mysqli_query($db,"SELECT reference_id FROM clients_references WHERE client_id='".$_SESSION['plan']['client_id']."' LIMIT 2, 1")or die(mysqli_error());
        ...
        <div class="button">
          <input type="submit" value="UPDATE" name="reference3" id="submit">
        </div>
...
function displayImage(e) {
  ...
  <script src="../asset/js/3reference.js"></script>
