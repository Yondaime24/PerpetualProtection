...
<head>
    ...
    <title>Perpetual Protection | Lumpsum</title>
...
<body>
  ...
  <br>
  <br>
    <center><div class="title"><h3>Plan 1 Lumpsum</h3></div></center>
  <br>
  <br>
    <div class="content">

    <h2 id="a">&#8369;14,250.00</h2>
    <p id="u">_____________Pay With_____________</p>

      <a href="#" class="logo"><img src="../images/lumpsom.png" class="image" alt="" width="200" style="margin-left: 60px; cursor: auto;" /></a>
      <h1 style="margin-left: 95px; margin-top: 20px;">Payment</h1>
