...
<div class="container">
  <a href="clientProfile1.php"><img src="../images/back_Arrow.png" width="30px"></a>
    <center><div class="title">Change Password</div></center>
    <div class="">

    <form class="" id="reg_form" action="clientPassUsernameEdit1.php" method="post" onsubmit="return checkInputs()" enctype="multipart/form-data">
...
<center>
          <div class="input-box" style="margin-top: 40px">
            ...
            <input type="text" value="<?php echo $res['username']; ?>" name="username" id="username" autocomplete="off">
          ...
          <div class="input-box">
           ...
           <span style="position: absolute; top: 280px; left: 800px; cursor: pointer;"><i style="color: #3498db" class="fas fa-eye" id="eye" onclick="toggle1()"></i></span> 
          ...
          <span style="position: absolute; top: 365px; left: 800px; cursor: pointer;"><i style="color: #3498db" class="fas fa-eye" id="eye2" onclick="toggle2()"></i></span>
</center>
...
<?php } ?>
        ...
        <div class="button">
         <input type="submit" value="UPDATE" name="update3" id="submit">
        </div>
